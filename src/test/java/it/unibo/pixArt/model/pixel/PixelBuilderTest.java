...
class PixelBuilderTest {
    ...
    private static final Pixel TEST_PIXEL = new PixelBuilder.PxlBuilder().setY(7).setX(4).build();
    private static final Pixel TEST_PIXEL_2 = new PixelBuilder.PxlBuilder().setY(7).setX(4).setColor(Color.ALICEBLUE).build();
